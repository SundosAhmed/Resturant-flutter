...
import 'package:resturent_app11/screens/cart/cartbloc.dart';
import 'package:resturent_app11/screens/payment/payment_screen.dart';
          ...
          Expanded(
            child: ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  return productTile(bloc.filteredList[index], index);
                }),
          ),
          Container(
            height: 175,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(child: Container()),
                      Text(" ₹ " + bloc.grantTotal(bloc.getBillTotal())),
                    ],
                  ),
                  const SizedBox(
                    height: 20,
